...
public class Duration
{
	...
	public void parse(String str) throws ParseException
	{
		...
		for (; index < len; index++)
		{
			...
			{
				throw new ParseException("Duration.parse(str='" + str + "') unexpected char '" + c + "' at index=" + index, index);
			}
		}
	}
	...
	public long getMillis()
	{
		...
		return factor * ((7 * 24 * 60 * 60 * weeks) + (24 * 60 * 60 * days) + (60 * 60 * hours) + (60 * minutes) + seconds);
	}
